...
Name:           ros-humble-lanelet2
Version:        1.2.3
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS lanelet2 package

License:        BSD
URL:            https://index.ros.org/p/lanelet2/#humble
Source0:        %{name}-%{version}.tar.gz

BuildArch:      noarch

Requires:       ros-humble-lanelet2-core
Requires:       ros-humble-lanelet2-examples
...
* Mon Oct 28 2024 Fabian Immel <fabian.immel@kit.edu> - 1.2.2-1
- Autogenerated by Bloom
